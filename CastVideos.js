...
function openYear(evt, yearNumber) {
...
CastPlayer.prototype.initializeCastPlayer = function() {
    ...
    options.receiverApplicationId = 'A6085E1B';
    ...
    console.log("CastPlayer.prototype.initializeCastPlayer");
};
...
CastPlayer.prototype.switchPlayer = function() {
    ...
    this.setupLocalPlayer();
    console.log("CastPlayer.prototype.switchPlayer");
};
...
CastPlayer.prototype.setupLocalPlayer = function () {
    ...
    console.log("CastPlayer.prototype.setupLocalPlayer");
};
...
CastPlayer.prototype.setupRemotePlayer = function () {
    ...
    this.playerHandler.play();
    console.log("CastPlayer.prototype.setupRemotePlayer");
};
...
CastPlayer.prototype.onMediaLoadedLocally = function() {
    ...
    console.log("CastPlayer.prototype.onMediaLoadedLocally");
};
...
CastPlayer.prototype.selectMedia = function(mediaIndex) {
    ...
    this.playerState = PLAYER_STATE.IDLE;
    this.playerHandler.play();
    console.log("CastPlayer.prototype.selectMedia");
};
...
CastPlayer.prototype.seekMedia = function(event) {
    ...
    console.log("CastPlayer.prototype.seekMedia");
};
...
CastPlayer.prototype.setVolume = function(mouseEvent) {
    ...
    console.log("CastPlayer.prototype.setVolume");
};
...
CastPlayer.prototype.startProgressTimer = function() {
    ...
    console.log("CastPlayer.prototype.startProgressTimer");
};
...
CastPlayer.prototype.stopProgressTimer = function() {
    ...
    console.log("CastPlayer.prototype.stopProgressTimer");
};
...
CastPlayer.prototype.incrementMediaTime = function() {
    ...
    console.log("CastPlayer.prototype.incrementMediaTime");
};
...
CastPlayer.prototype.updateProgressBarByTimer = function() {
    ...
    console.log("CastPlayer.prototype.updateProgressBarByTimer");
};
...
CastPlayer.prototype.endPlayback = function() {
    ...
    console.log("CastPlayer.prototype.endPlayback");
};
...
var mediaJSON = { 'categories' : [{ 'name' : 'Movies',
    'videos' : [
        { 'description' : "Media Soft Day 2016",
            'sources' : ['http://flash.metropolia.fi/streams/636/video/o_1af67suae17q81pt51giils21e267.mp4'],
            'subtitle' : 'Visa Parviainen',
            'thumb' : 'https://flash.metropolia.fi/streams/thumbs/1493_s.jpg',
            'title' : 'Automatic security testing'
        },
        { 'description' : 'Media Soft Day 2016',
            'sources' : ['https://flash.metropolia.fi/streams/636/video/o_1af681h79mhh131p1pmcti01imb7.mp4'],
            'subtitle' : 'Tero Ahonen',
            'thumb' : 'https://flash.metropolia.fi/streams/thumbs/1494_s.jpg',
        ...
        { 'description' : 'Media Soft Day 2016',
            ...
            'subtitle' : 'Jouni Leino',
            'thumb' : 'https://flash.metropolia.fi/streams/thumbs/1495_s.jpg',
            'title' : 'Automate everything'
        },
        { 'description' : "Media Soft Day 2016",
            'sources' : ['https://flash.metropolia.fi/streams/636/video/o_1af68ap05mlv1pr51831gvr19pi7.mp4'],
            'subtitle' : 'Frans Tihveräinen',
            'thumb' : 'https://flash.metropolia.fi/streams/thumbs/1496_s.jpg',
        ...
        { 'description' : 'Media Soft Day 2016',
            ...
            'subtitle' : 'Ali Rantakari',
            'thumb' : 'https://flash.metropolia.fi/streams/thumbs/1498_s.jpg',
